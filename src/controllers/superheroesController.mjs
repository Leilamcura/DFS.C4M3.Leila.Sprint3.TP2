...
import { obtenerSuperheroePorId, obtenerTodosLosSuperheroes, buscarSuperheroesPorAtributo, obtenerSuperheroesMayoresDe30, crearSuperheroeService, editarSuperheroeService, eliminarSuperheroePorIdService, eliminarSuperheroePorNombreService } from "../services/superheroesService.mjs";
...
export async function obtenerTodosLosSuperheroesController(req, res) {
    try {
        ...
        console.log('Estoy en la capa del controlador, en la funcion obtenerTodosLosSuperheroesController, y son los siguientes: ', superheroes)
...
export async function obtenerSuperheroesMayoresDe30Controller(req, res) {
    try {
        ...
        console.log('Estoy en la capa del controlador, en la funcion obtenerSuperheroesMayoresDe30 y y son los siguientes: ', superheroes)
        if (superheroes.length === 0) {
...
export async function crearSuperheroeController(req, res) {
    try {
        ...
        console.log('Estoy en la capa del controlador, en la funcion crearSuperheroeController y llegó esta informacion: ', datos)
...
export async function editarSuperheroeController(req, res) {
    try {
        ...
        const datos = req.body;
        console.log('Estoy en la capa del controlador, en la funcion editarSuperheroeController y llegó esta informacion: ', datos)
...
export async function eliminarSuperheroePorIdController(req, res) {
    try {
        const { id } = req.params;
        console.log('Estoy en la capa del controlador, en la funcion eliminarSuperheroeController y llegó el siguiente ID: ', id)
        const superheroe = await eliminarSuperheroePorIdService(id);
        if (superheroe) {
            res.send(renderizarSuperheroe(superheroe));
            console.log('Se eliminó el siguiente superheroe:', superheroe)
        } else {
...
export async function eliminarSuperheroePorNombreController(req, res) {
    try {
        const { nombreSuperheroe } = req.params;
        console.log('Estoy en la capa del controlador, en la funcion eliminarSuperheroePorNombreController y llegó el siguiente nombre: ', nombreSuperheroe)
